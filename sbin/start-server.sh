...
nohup java -jar $GLINT_PATH/bin/Glint-assembly-0.1-SNAPSHOT.jar server -c $GLINT_PATH/conf/default.conf > $GLINT_PATH/logs/server-out.log 2> $GLINT_PATH/logs/server-err.log &
